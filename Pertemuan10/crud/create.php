...
<body>
    <div class="container mt-4">
        ...
        <form action="proses.php?aksi=tambah" method="post"> <!-- Form untuk menambahkan data anggota baru -->
            <div class="form-group">    
                <label for="nama">Nama: </label> 
                <input type="text" class="form_control" name="nama" id="nama" required> 
            </div>
            <div class="form-group">    
            ...
            <div class="form-group">    
                ...
                <input type="text" class="form_control" name="alamat" id="alamat" required>
            </div>
            <div class="form-group">    
                <label for="no_telp">No. Telp:</label>
                <input type="text" class="form_control" name="no_telp" id="no_telp" required>
            </div>
